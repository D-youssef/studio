          ...
          <div className="space-y-20">
            {PRODUCTS.map((product, index) => (
              <div key={product.slug} className="grid md:grid-cols-2 gap-12 items-center">
                <AnimatedOnScroll animationName={index % 2 !== 0 ? 'animate__fadeInRight' : 'animate__fadeInLeft'}>
                ...
                <AnimatedOnScroll animationName={index % 2 !== 0 ? 'animate__fadeInLeft' : 'animate__fadeInRight'}>
